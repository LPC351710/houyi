package com.ppm.ppcomon.widget.addresspicker.popup;
...
import com.ppm.ppcomon.widget.addresspicker.common.ScreenUtils;
...
public abstract class BasicPopup<V extends View> implements DialogInterface.OnKeyListener,
     ...
     * 宽度为屏幕的一半
     */
    public void setHalfWidthScreen(boolean halfScreen) {
        if (halfScreen) {
            setSize(screenWidthPixels, screenHeightPixels * 2 / 5);
        }
    }
