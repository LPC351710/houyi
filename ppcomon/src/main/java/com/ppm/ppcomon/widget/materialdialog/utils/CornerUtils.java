package com.ppm.ppcomon.widget.materialdialog.utils;
...
public class CornerUtils {
    ...
    public static StateListDrawable btnSelector(float radius, int normalColor, int pressColor, int postion) {
        ...
        } else if (postion == 2) {// no radius
            normal = cornerDrawable(normalColor, new float[]{0, 0, 0, 0, 0, 0, 0, 0});
            pressed = cornerDrawable(pressColor, new float[]{0, 0, 0, 0, 0, 0, 0, 0});
        } else if (postion == 3) {//top left
            normal = cornerDrawable(normalColor, new float[]{radius, radius, 0, 0, 0, 0, 0, 0});
            pressed = cornerDrawable(pressColor, new float[]{radius, radius, 0, 0, 0, 0, 0, 0});
        } else if (postion == 4) {//top-left&&bottom-left
            normal = cornerDrawable(normalColor, new float[]{radius, radius, 0, 0, 0, 0, radius, radius});
            pressed = cornerDrawable(pressColor, new float[]{radius, radius, 0, 0, 0, 0, radius, radius});
        } else if (postion == 5) {//top-right&&bottom-right
            normal = cornerDrawable(normalColor, new float[]{0, 0, radius, radius, radius, radius, 0, 0});
            pressed = cornerDrawable(pressColor, new float[]{0, 0, radius, radius, radius, radius, 0, 0});
        } else if (postion == 6) {//top-right
            normal = cornerDrawable(normalColor, new float[]{0, 0, radius, radius, 0, 0, 0, 0});
            pressed = cornerDrawable(pressColor, new float[]{0, 0, radius, radius, 0, 0, 0, 0});
        }
