...
import com.ppm.ppcomon.widget.addresspicker.entity.City;
import com.ppm.ppcomon.widget.addresspicker.entity.County;
        ...
        private void parseData(List<Province> data) {
            ...
            for (int x = 0; x < provinceSize; x++) {
                ...
                for (int y = 0; y < citySize; y++) {
                    ...
                    cit.setProvinceId(pro.getArea_id());
                    xCities.add(cit);
