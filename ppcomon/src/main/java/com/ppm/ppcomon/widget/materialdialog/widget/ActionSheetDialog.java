...
import com.ppm.ppcomon.widget.materialdialog.entity.DialogMenuItem;
import com.ppm.ppcomon.widget.materialdialog.listener.OnOperItemClickL;
import com.ppm.ppcomon.widget.materialdialog.utils.CornerUtils;
import com.ppm.ppcomon.widget.materialdialog.widget.base.BottomBaseDialog;
...
public class ActionSheetDialog extends BottomBaseDialog {
     ...
     * item 取消按钮的颜色
     */
    private int itemCancelColor = Color.parseColor("#44A2FF");
    /**
     ...
     * 取消按钮的字体大小
     */
    private float itemCancelTextSize_SP = 17.5f;
    /**
    ...
    public ActionSheetDialog(Context context, ArrayList<DialogMenuItem> baseItems, View
            animateView) {
    ...
    public void setUiBeforShow() {
        ...
        tv_title.setBackgroundDrawable(CornerUtils.cornerDrawable(titleBgColor, new
        ...
        /** title underline */
        v_line_title.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, dp2px
                (dividerHeight_DP)));
        ...
        tv_cancel.setTextSize(TypedValue.COMPLEX_UNIT_SP, itemCancelTextSize_SP);
        tv_cancel.setTextColor(itemCancelColor);
        tv_cancel.setBackgroundDrawable(CornerUtils.listItemSelector(radius, lvBgColor,
                itemPressColor, 1, 0));
        ...
        tv_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onCancelClickListener != null) {
                    onCancelClickListener.onClick(null, 0);
                }
            }
        });
        ...
        if (isTitleShow) {
            lv.setBackgroundDrawable(CornerUtils.cornerDrawable(lvBgColor, new float[]{0, 0, 0,
    ...
    public int getItemCancelColor() {
        return itemCancelColor;
    }

    public ActionSheetDialog setItemCancelColor(int itemCancelColor) {
        this.itemCancelColor = itemCancelColor;
        return this;
    }

    public float getItemCancelTextSize_SP() {
        return itemCancelTextSize_SP;
    }

    public ActionSheetDialog setItemCancelTextSize_SP(float itemCancelTextSize_SP) {
        this.itemCancelTextSize_SP = itemCancelTextSize_SP;
        return this;
    }
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tv_item.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams
                    .WRAP_CONTENT));
            ...
            float radius = dp2px(cornerRadius_DP);
            if (isTitleShow) {
                ll_item.setBackgroundDrawable((CornerUtils.listItemSelector(radius, Color
                                .TRANSPARENT, itemPressColor,
