package com.ppm.ppcomon.widget.materialdialog.widget.internal;
...
import com.ppm.ppcomon.widget.materialdialog.widget.base.BaseDialog;
        ...
        tv_btn_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnLeftClickL != null) {
                    onBtnLeftClickL.onBtnClick(BaseAlertDialog.this);
                } else {
                    dismiss();
                }
            }
        ...
        tv_btn_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnRightClickL != null) {
                    onBtnRightClickL.onBtnClick(BaseAlertDialog.this);
                } else {
                    dismiss();
                }
            }
        ...
        tv_btn_middle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnMiddleClickL != null) {
                    onBtnMiddleClickL.onBtnClick(BaseAlertDialog.this);
                } else {
                    dismiss();
                }
            }
