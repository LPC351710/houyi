package com.ppm.ppcomon.widget.addresspicker.common;
...
public class DateUtils extends android.text.format.DateUtils {
     ...
     * 将指定的日期转换为一定格式的字符串
     */
    public static String formatDate(long timeSecond) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.PRC);
        return sdf.format(timeSecond * 1000);
    }

    /**
     * 将指定的日期转换为一定格式的字符串
     */
    public static String formatDate(long timeSecond, String format) {
