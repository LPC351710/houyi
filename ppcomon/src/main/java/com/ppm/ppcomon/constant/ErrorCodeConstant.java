...
public class ErrorCodeConstant {
    ...
    static {
        ...
        MAP_ERROR_CODE.put(ERR_CODE_HTTP_CODE_ERROR, "网络连接异常，请检测您的网络是否连接正常");        // "后台服务HTTP响应异常"
        MAP_ERROR_CODE.put(ERR_CODE_HTTP_RESPONSE_ERROR, "网络连接异常，请检测您的网络是否连接正常");        // "后台服务响应数据异常" http CODE != 200
